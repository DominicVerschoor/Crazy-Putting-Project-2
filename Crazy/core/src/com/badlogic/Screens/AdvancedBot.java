...
public class AdvancedBot
{
    ...
    public double [] getAdvancedBot() { return currentPositions; }

    public void setVelocities(double [] velocities) { currentVelocities = velocities; }
    
    public double [] getVelocities() { return currentVelocities; }
    ...
    public AdvancedBot HillClimbingMethod(double [] startPosition, double [] goalPosition, double val)
    //public double HillClimbingMethod(double [] startPosition, double [] goalPosition, double val)
    {
...

        {
            ...
            /*
            if(newPosition.getAdvancedBot().equals(startPosition))
            {
                double[] tempvelo = newPosition.getVelocities();
                xbounds[0] = tempvelo[0] - 5;
                xbounds[1] = tempvelo[0] + 5;
                ybounds[0] = tempvelo[1] - 5;
                ybounds[1] = tempvelo[1] + 5;
            }*/
        ...
        while (distanceOfVectors(currentPosition, goalPosition) > 0.15) // Change 0.5 with the radius of our hole!!!!!!!
        {
            System.out.println("I am in the while loop - before the if AdvancedBotment.");
            newPosition = findNextAdvancedBot(startPosition, goalPosition, xbounds, ybounds);
            count++;
