...
public class BasicBot {
    ...
    public double[] basicShooting() {
        ...
        while (((r.r <= distance(save[0], save[1], holeX, holeY) - radius)) && (yvel <= 5 || (xvel <= 5))) {
        ...
        yvel = -5;
        while (((r.r <= distance(save[0], save[1], holeX, holeY) - radius)) && (yvel <= 5)) {
        ...
        xvel = -5;
        while (((r.r <= distance(save[0], save[1], holeX, holeY) - radius)) && (xvel <= 5)) {
